Для запуска установите node.js и в командную строку введите "npm run dev" или "node server.js"
...
Уверены, что вы справитесь быстрее срока. Обычно на это задание стажёры тратят от 3 до 5 часов. Будет жаль, если вы не используете возможность проявить себя, и мы не увидим Вас на следующем этапе отбора.
